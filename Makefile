...
MODULES=ast type lexer common genxml parser typecore optimizer typeload \
	...
	genswf9 genswf genjava gencs genpy genswift interp dce analyzer filters typer matcher version main
